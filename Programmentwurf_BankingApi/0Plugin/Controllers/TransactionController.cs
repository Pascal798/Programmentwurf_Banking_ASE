...
namespace Programmentwurf_BankingApi.Plugin.Controllers
{
    ...
    public class TransactionController : ControllerBase
    {
        ...
        [HttpPost]
        public CreatedAtActionResult PostTransactionEntity(TransactionEntity transactionEntity)
        {
            TransactionRepositoryBridge.create(transactionEntity);

            return CreatedAtAction(nameof(GetTransactionEntity), new { transactionid = transactionEntity.Id }, transactionEntity);
        }
